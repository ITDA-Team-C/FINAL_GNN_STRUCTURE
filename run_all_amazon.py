"""Run 7 models on Amazon dataset (.mat format).

Usage:
    # Place Amazon.mat in amazon/data/ first
    python run_all_amazon.py                        # all 7 models
    python run_all_amazon.py --only cage_carerf     # one model
    python run_all_amazon.py --mat-path /path/to/Amazon.mat
...
def main():
    ...
    print(f"=== Amazon: running {len(plan)}/{len(MODELS)} models on {device} ===")
